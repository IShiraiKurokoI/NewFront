    ...
    <el-table :data="checkData" stripe style="width: 100%" border>
       <el-table-column label="编号" prop="chId"></el-table-column>
             <el-table-column label="项目" prop="chName"></el-table-column>
              <el-table-column label="价格/元" prop="chDescription"></el-table-column>
          <el-table-column label="操作" width="140">
        <template slot-scope="scope">
          <el-button size="mini" type="success" icon="el-icon-edit" @click="modifyDialog(scope.row.chId)"></el-button>
          <el-button
            size="mini"
            type="danger"
            icon="el-icon-delete"
  ...
  <!-- 增加检查项目对话框 -->
    <el-dialog title="增加检查项目" :visible.sync="addFormVisible">
      <el-form :model="addForm" :rules="rules" ref="ruleForm">
        ...
        <el-form-item label="价格" prop="chDescription" label-width="80px">
            <el-input v-model="addForm.chDescription"></el-input>
        </el-form-item>
      </el-form>
