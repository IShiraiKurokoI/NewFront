      ...
      <el-col :span="6">
        ...
        <el-table :data="orderData" stripe border>
            ...
            <el-table-column label="操作">
                <template slot-scope="scope">
                    <el-button type="danger" size="small" @click="BedDiag(scope.row.pId, scope.row.dId)">申请住院</el-button>
                </template>
            </el-table-column>
...
<!-- 住院对话框 -->
      ...
      >
        ...
        <el-button type="primary" @click="bedClick"
          >确 定</el-button
        >
      </div>
    </el-dialog>
...
export default {
    ...
    handleCurrentChange(num) {
      ...
      this.requestOrders();
        ...
        //获取已完成的订单信息
        requestOrders(){
            request.get("order/findOrderFinish", {
                params: {
                    dId: this.userId,
