   ...
   <el-table :data="doctorData" border>
     ...
     <el-table-column label="操作" prop="dSection">
       <template slot-scope="scope">
         <el-button type="success" size="mini" @click="arrangeClick(scope.row.dId)">排班</el-button>
       </template>
     </el-table-column>
   </el-table>
    <!-- 分页 -->
...
export default {
    ...
    methods: {
        ...
        arrangeClick(dId){
            ...
            request.get("arrange/addArrange", {
                params: {
    ...
    handleCurrentChange(num) {
      ...
      this.requestDoctors();
          ...
          //根据部门请求医生信息
      requestDoctors(){
        request.get("doctor/findDoctorBySectionPage", {
          params: {
